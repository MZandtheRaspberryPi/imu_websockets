...
mkdir build && cd build
cmake -E env CXXFLAGS="-fPIC" cmake .. -Dprotobuf_BUILD_TESTS=OFF -Dprotobuf_ABSL_PROVIDER=package -Dabsl_DIR=/abseil/CMakeProject/install/lib/cmake/absl -DBUILD_SHARED_LIBS=ON
cmake --build . --target install
